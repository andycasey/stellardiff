...
class ProfileFittingModel(BaseSpectralModel):
    ...
    def __init__(self, transitions, **kwargs):
        """
        Initialize a class for modelling an atomic transition using a profile.
        """

        super(ProfileFittingModel, self).__init__(transitions, **kwargs)
        ...
        for key, value in kwargs.items():
            if key in self.metadata:
                ...
                logging.warn("Ignoring keyword {} for {}".format(
    ...
    def fit(self, spectrum, **kwargs):
        ...
        #self.meets_quality_constraints_in_parent_session
    ...
    def equivalent_width(self):
        ew, ew_pos, ew_neg = self.metadata["fitted_result"][2]["equivalent_width"] 
        return (ew * u.Angstrom,
                ew_pos * u.Angstrom,
                ew_neg * u.Angstrom)
